...
1. Run `npm test` — vitest smoke must pass (currently 21 tests)
...
- Keep the extractor prompt-first and lean; flag changes that add new runtime dependencies or host-specific behavior
